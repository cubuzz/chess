# chess
[![Build and Test](https://github.com/cubuzz/chess/actions/workflows/build-and-test.yaml/badge.svg)](https://github.com/cubuzz/chess/actions/workflows/build-and-test.yaml)
[![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/github.com/cubuzz/chess)
...
```bash
go get -u github.com/cubuzz/chess
``` 
